...
class ModelSqliteSettings extends _ModelSqliteSettings with EquatableMixin {
  ...
  static const tableName = 'sqlite_settings';
  ...
  static ModelSqliteSettings? fromJsonOrNull(
    ...
    try {
      ...
      final notificationsEnabled =
          letBoolOrNull(json?['notifications_enabled']);
      final theme = json?['theme']?.toString().trim().nullIfEmpty;
      final lastSyncedAt = () {
        final a = letIntOrNull(json?['last_synced_at']);
        return a != null
            ? DateTime.fromMillisecondsSinceEpoch(a, isUtc: true)
            : null;
      }();
      final legacyCreatedAt = () {
        final a = json?['legacy_created_at']?.toString().trim().nullIfEmpty;
        return a != null ? DateTime.tryParse(a)?.toUtc() : null;
      }();
      final preferences = letMapOrNull<dynamic, dynamic>(json?['preferences'])
          ?.map(
            (p0, p1) => MapEntry(
  ...
  Map<String, dynamic> toJson({
    ...
    try {
      ...
      final notificationsEnabled0 =
          notificationsEnabled == null ? null : (notificationsEnabled! ? 1 : 0);
      ...
      final withNulls = {
        ...
        'notifications_enabled': notificationsEnabled0,
        'legacy_created_at': legacyCreatedAt0,
        'last_synced_at': lastSyncedAt0,
        'id': id0,
        'avatar_cache': avatarCache0,
      };
...
extension ModelSqliteSettingsX on ModelSqliteSettings {
  ...
  ModelSqliteSettings copyWithout({
    ...
    return ModelSqliteSettings.assertRequired(
      ...
      notificationsEnabled:
          notificationsEnabled ? this.notificationsEnabled : null,

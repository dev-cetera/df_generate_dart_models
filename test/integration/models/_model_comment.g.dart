...
class ModelComment extends _ModelComment with EquatableMixin {
  ...
  static const tableName = 'comment';

  /// Field list backing `==` and `hashCode` via [EquatableMixin]. Preserves
  /// the same value semantics across hand-construction and `fromJson`
  /// round-trips since every field is included.
  @override
  List<Object?> get props => [id, authorId, body, parentId, createdAt];
...
abstract final class ModelCommentFieldNames {
  ...
  static const List<String> $values = [id, authorId, body, parentId, createdAt];

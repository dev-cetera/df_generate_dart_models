...
final dimensions = () { final a = letMapOrNull<String, dynamic>(json?['dimensions']); return a != null ? ModelDimensions.fromJson(a): null; }();
...
final dimensions0 = dimensions != null ? jsonEncode(dimensions!.toJson()) : null;
final altText0 = altText?.trim().nullIfEmpty;
      final withNulls = {
        'mime': mime0,'duration_ms': durationMs0,'dimensions': dimensions0,'byte_size': byteSize0,'alt_text': altText0,
      };
